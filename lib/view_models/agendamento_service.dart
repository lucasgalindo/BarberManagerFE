...
class AgendamentoService {
    ...
    static final AgendamentoService _instance = AgendamentoService._privateConstructor();
    ...
    addBarber(Barber barber) {
        ...
        var currentAgendamento = Servico(name: currentService.name, description: currentService.name, barber: currentBarber!, price: currentService.price, barbershop: barbershop);
  ...
  final selectedTimes = selectedTimePerService.entries
      .where((entry) =>
